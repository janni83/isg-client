...
const ENERGY_MANAGEMENT = {
  ...
  UPPER_TEMP_HK1: new Parameter({ id: "val60310", min: 20, max: 50 }),
  UPPER_TEMP_HK2: new Parameter({ id: "val60311", min: 20, max: 30 }),
  UPPER_TEMP_DH: new Parameter({ id: "val60312", min: 40, max: 65 }),
  // HEATPUMP_TYPE: new Parameter({id: "val60317", values: ["0", "5", "63", "66"]}),
};
